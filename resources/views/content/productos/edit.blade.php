                ...
                <div class="panel panel-default">
                                <div class="panel-body">                                                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            ...
                                            <option value=""> SELECCIONA UNA CATEGORIA </option>
                                                @foreach($combo as $item)
                                                    @if($datos->idcategoriaproducto == $item->id)
                                    ...
                                    <div class="form-group {{$errors->has('descripcionlarga') ? 'has-error':''}}">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" rows="5" name="descripcionlarga">{{$datos->descripcionlarga}}</textarea>
                                    ...
                                    <div class="form-group {{$errors->has('descripcioncorta') ? 'has-error':''}}">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" rows="5" name="descripcioncorta">{{$datos->descripcioncorta}}</textarea>
