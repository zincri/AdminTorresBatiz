...
{!!Form::model($datos,array('method'=>'PATCH','route'=>['slider.update',$datos->id],'files' => 'true'))!!}
{{Form::token()}}
                ...
                <div class="panel panel-default">
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group {{$errors->has('tituloglobo') ? 'has-error':''}}">
                                        <label class="col-md-3 col-xs-12 control-label">Titulo Globo</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="tituloglobo" value="{{$datos->tituloglobo}}"/>
                                            </div>                                            
